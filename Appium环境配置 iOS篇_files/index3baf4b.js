...
var v="",y=new Image;
y.src=("http://mp.weixin.qq.com/mp/jsreport?key=4&content=biz:"+biz+",mid:"+mid+",uin:"+uin+"[key4]"+v+"&r="+Math.random()).substr(0,1024);
}
...
e("appmsg/share.js");
var x=w(1e3*parseInt(top.window.modify_time)),R=x.format("YYYY-MM-DD HH:mm"),z=document.getElementById("js_modify_time");
if(z&&(z.innerHTML=R),window.isSg||"mp.weixin.qq.com"==location.host){
var E=e("biz_common/log/jserr.js");
E({
key:0,
...
var q=-1!=navigator.userAgent.indexOf("TBS/"),B=function(e,o){
t(e,function(e,t){
...
q&&1>=i&&(n.lossy=n.lossless=n.alpha=1,window.logs.webplog=n);
...
(f||navigator.userAgent.indexOf("Br_trunk")>-1)&&o&&p.isIOS&&p.gtVersion("6.5.13",!0)?(console.log("当前版本可以启用img代理"),
...
B("lossy",e),B("lossless",e),B("alpha",e),B("animation",e);
};
window.webp=!1,k(function(){
S(function(t){
function o(e){
...
d&&(d.isCDN()&&(d=d.imgChange640(),t&&(d=j.addParam(d,"tp","webp",!0)),d=j.addParam(d,"wxfrom","5",!0),
...
w&&(n>=43305||d>=16)&&o.isGif()?(o=j.addParam(o,"tp","wxpic",!0),window.__addIdKeyReport("28307",91)):window.webp&&(o=j.addParam(o,"tp","webp",!0),
window.__addIdKeyReport("28307",84)),o=j.addParam(o,"wxfrom","5",!0),is_https_res||u?(o=o.http2https(),
...
return h&&o.isGif()&&(window.__addIdKeyReport("28307",106),o=j.addParam(o,"tp","wxpic",!0),
...
var T=e("appmsg/copyright_report.js");
!function(){
...
var O=e("appmsg/review_image.js"),C=document.getElementById("js_cover"),N=[];
C&&N.push(C),new O({
container:document.getElementById("js_content"),
...
if(T.card_pv_report(),Math.random()<.01)try{
...
var D=Math.random();
if(2e-4>D)try{
for(var M=document.getElementsByTagName("img"),W=window.screen.height,Q=window.screen.width,P=0,L=window.devicePixelRatio,P="",U=0,G=M.length;G>U;U++){
var H=M[U].getAttribute("data-src");
if(H){
var J=M[U].getBoundingClientRect();
P+=Q+"|"+W+"|"+J.left.toFixed(2)+"|"+(Q-J.right).toFixed(2)+"|"+J.width.toFixed(2)+"|"+L.toFixed(2)+"|"+H+";";
}
}
a({
